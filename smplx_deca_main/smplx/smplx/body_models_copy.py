...
class SMPL(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        shapedirs = shapedirs[:, :, :num_betas] #/// No sé muy bien qué es el shapedirs y porqué se cambia su tamaño al siguiente
        ...
        if create_betas:
            if betas is None:
                ...
                else: #/// No entiendo este caso y porqué debería darse
