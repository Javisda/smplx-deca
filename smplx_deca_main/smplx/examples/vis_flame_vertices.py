...
def main(model_folder, corr_fname, ext='npz',
    ...
    # Vertex Manipulation --- TESTING
    # vertices[head_idxs] *= 2 # Make head twice big

    # Load Pickle
    import pickle
    with open("id_opdict.pickle", "rb") as f:
        head_dict = pickle.load(f)
    vertices[head_idxs] = head_dict['verts']
    vertices_copy = vertices.copy()

    # Add offset to y coordinate
    vertices_copy[head_idxs, 1] += 0.295
    # Add offset to z coordinate
    vertices_copy[head_idxs, 2] += 0.045
    vertices_copy[head_idxs, :] *= 0.5
    ...
    """
    save_obj('Example_3.obj', vertices, model.faces)
...
def save_obj(filename, vertices, faces):
    ...
    print("Vis_Flame_Vertices Saved")


if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='smpl-X Demos')
