...
def main(model_folder,
    ...
    if plotting_module == 'pyrender':
        ...
        import trimesh
        import random
        vertex_colors = np.ones([vertices.shape[0], 4]) * [random.uniform(0, 1), random.uniform(0, 1), random.uniform(0, 1), 0.8]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_folder', default='basicModel_f_lbs_10_207_0_v1.1.0.pkl', type=str,
                        help='The path to the model folder')
    parser.add_argument('--model-type', default='smplx', type=str,
                        choices=['smpl', 'smplh', 'smplx', 'smplh', 'flame'],
