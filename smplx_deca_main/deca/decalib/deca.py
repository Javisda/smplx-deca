...
class DECA(nn.Module):
    ...
    def _auxiliar_setup_render(self, model_cfg): # Added
        ...
        # Dependiendo del rasterizador
        from smplx_deca_main.deca.decalib.utils.util import load_obj
        verts, uvcoords, faces, uvfaces = load_obj(obj_filename)
        self.faces = faces[None, ...]
        self.uvfaces = uvfaces[None, ...]
        self.raw_uvcoords = uvcoords[None, ...]
    ...
    def _create_model(self, model_cfg):
        # set up parameters
        self.n_param = model_cfg.n_shape+model_cfg.n_tex+model_cfg.n_exp+model_cfg.n_pose+model_cfg.n_cam+model_cfg.n_light #/// n_param = 236 -> Buscar en paper
        self.n_detail = model_cfg.n_detail #/// n_detail = 128 -> Buscar en paper
